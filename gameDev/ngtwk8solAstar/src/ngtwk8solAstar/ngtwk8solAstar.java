...
import java.io.*;
public class ngtwk8solAstar extends JFrame implements Runnable, MouseListener, MouseMotionListener,
KeyListener{
	// member data
	...
	public ngtwk8solAstar () {
	 ...
	 addMouseListener(this); //click
	 addMouseMotionListener(this); //drag
	 addKeyListener(this); //arrows
	...
	public void run() {
		...
		while ( 1==1 ) {
			...
			if (isGameRunning) {
				loops++;
				//if player moves or three new frames were drawn, badguy moves
	...
	private void loadMaze() {
		...
		if (textinput!=null) {
			for (int x=0;x<40;x++) {
				for (int y=0;y<40;y++) {
					//if character is 1 cell is true
	...
	// mouse events which must be implemented for MouseListener
	 public void mousePressed(MouseEvent e) {
		 ...
		 if (isGameRunning) //** if maze changes, recalc path
	...
	// Keyboard events
	 ...
	 public void keyReleased(KeyEvent e) {
		 //when player released keys, stop moving
	...
	public static void main(String[] args) {
		ngtwk8solAstar w = new ngtwk8solAstar();
	}
}
